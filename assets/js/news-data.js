...
const newsData = [

    {
        ...
        summary: "Prepare-se para vestir as cores da Frenesy! A coleção 2025 está a caminho, com uniformes, moletons e acessórios exclusivos para a nossa comunidade.",
        content: `
            ...
            <h2>O que esperar da Coleção 2025?</h2>
...

    {
        ...
        content: `
            ...
            <h2>Quando começam as inscrições?</h2>
            <p>As inscrições estão abertas a partir de <strong>hoje, 01 de setembro de 2025</strong>, e a peneira está prevista para acontecer no <strong>final deste mês</strong>. Portanto, se você sonha em representar a Frenesy, já pode garantir a sua vaga!</p>
            ...
            <p>Não fique de fora, garanta já sua inscrição e venha lutar pelo seu lugar na Frenesy!</p>
        `
    },
